...
public class GetPredecessorResponse extends ResponseAction {

    private Node node;

    public GetPredecessorResponse(String requestId, Node node) {
        super(requestId);
        this.node = node;
    }

    public GetPredecessorResponse(DhtEvent dhtEvent) throws IOException {
        super(dhtEvent);
    }
